  ...
  return (
    <nav className="bg-white border-b border-slate-200 sticky top-20 z-40">
      <div className="container mx-auto px-8 lg:px-12 max-w-[1600px]">
        {/* Added pl-24 to push the centered tabs slightly towards the right */}
        <div className="flex items-center justify-center h-16 relative pl-24">
              ...
              return (
                ...
                >
                  ...
                  {openCategory === category.label && (
                    <div className="absolute top-[100%] left-1/2 -translate-x-1/2 pt-1 min-w-[240px] animate-in fade-in slide-in-from-top-2 duration-150">
          ...
          <div className="absolute right-0 hidden xl:flex items-center">
